...
import { Users, Trash2, Shield, User, Loader2, AlertTriangle, Search } from 'lucide-react';
...
const AdminManageUsersPage = () => {
  ...
  const deleteUserMutation = useMutation({
    ...
    onSuccess: () => {
      toast.success('User and all associated products, likes, and comments deleted successfully!');
      setDeletingId(null);
  ...
  const handleDeleteUser = (userId: string, userName: string) => {
    if (confirm(`Are you sure you want to delete user "${userName}"? This will also remove ALL products, likes, comments, and requests associated with this user!`)) {
      ...
      <div className="space-y-8">
        ...
        <div className="bg-gradient-to-r from-gray-900 to-slate-800 p-8 rounded-3xl text-white shadow-xl flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            ...
            <h1 className="text-3xl font-black mt-2">Registered Users Directory</h1>
            <p className="text-gray-300 text-sm mt-1">
              View, manage, or remove registered platform members with automatic cascading data cleanup.
            </p>
          </div>
              ...
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="divide-y divide-gray-100 dark:divide-gray-800 text-sm">
                  {filteredUsers.map(user => {
                    ...
                    return (
                      <tr key={userId} className="hover:bg-gray-50/50 dark:hover:bg-[#1e293b]/30 transition-colors">
