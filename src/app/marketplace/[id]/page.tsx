...
// ⚠️ তোমার Better Auth client এর actual path বসাও (ReuseHub/FundOra তে যেভাবে আছে)
...
const ProductDetailsPage = () => {
  ...
  const handleLikeToggle = () => {
    if (!currentUser) {
      alert('Like korte hole age login korte hobe');
      return;
    }
    likeMutation.mutate();
  };
          ...
          <div className="space-y-5">
            ...
            <div className="bg-white dark:bg-[#0b1120] p-5 rounded-2xl border border-gray-100 dark:border-gray-800">
              ...
              <div className="flex gap-3 mt-4">
                <button className="flex-1 px-6 py-3.5 bg-[#16503b] text-white rounded-xl font-black uppercase tracking-wide text-xs hover:bg-[#1a6b4f] transition-all flex items-center justify-center gap-2">
                  <ShoppingCart size={16} /> Buy Now
                </button>
                <button className="flex-1 px-6 py-3.5 border-2 border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 rounded-xl font-black uppercase tracking-wide text-xs hover:border-[#16503b] hover:text-[#16503b] transition-all">
                  Add to Cart
                </button>
                <button
